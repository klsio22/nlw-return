  ...
  return (
    <>
      ...
      <div className='flex flex-col items-center py-10 w-[304]'>
        ...
        <span className='text-xl mt-1'>Agredecemos o feedback!</span>

        <button
          className='py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent
           text-sm leading-6 hover:bg-slate-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 
           focus:ring-brand-500 transparent-colors disabled:opacity-50
